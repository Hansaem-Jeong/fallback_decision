...
DEFINES_STANDARD = -DMODEL=P_result
...
SRCS = $(START_DIR)/P_result_data.cpp $(START_DIR)/P_result_initialize.cpp $(START_DIR)/P_result_terminate.cpp $(START_DIR)/P_result.cpp $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/nvidia/sources/utils/MW_nvidia_init.c
...
OBJS = P_result_data.cpp.o P_result_initialize.cpp.o P_result_terminate.cpp.o P_result.cpp.o MW_nvidia_init.c.o
...
P_result_data.cpp.o : $(START_DIR)/P_result_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


P_result_initialize.cpp.o : $(START_DIR)/P_result_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


P_result_terminate.cpp.o : $(START_DIR)/P_result_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


P_result.cpp.o : $(START_DIR)/P_result.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
